...
const circumferenceResultEl = document.querySelector('#circle-stats tbody tr:nth-child(1) td:nth-child(2)');
const areaResultEl = document.querySelector('#circle-stats tbody tr:nth-child(2) td:nth-child(2)');
const volumeResultEl = document.querySelector('#circle-stats tbody tr:nth-child(3) td:nth-child(2)');
const litersResultEl = document.querySelector('#circle-stats tbody tr:nth-child(4) td:nth-child(2)');
